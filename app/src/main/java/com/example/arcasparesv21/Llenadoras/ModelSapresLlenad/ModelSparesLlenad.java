package com.example.arcasparesv21.Llenadoras.ModelSapresLlenad;

public class ModelSparesLlenad {
  private int ID;
  ...
  public ModelSparesLlenad(){}
  public ModelSparesLlenad(int ID, String cantidad, String códigoSAP, String descripciónBreve, String descripciónExtensa, String elemento, String imagen, String marca, String nombreTécnico, String númeroDeParte, String enlaceImagen) {
    this.ID = ID;
    Cantidad = cantidad;
    CódigoSAP = códigoSAP;
